...
public class ProcessoSeletivo3 
{
    ...
    static void entrandoEmContato(String candidato)
    {
        ...
        do
        {
            // elas precisarão sofrer alterações as variaveis
            atendeu = atender();
    ...
    // método auxiliar atender -> atraves de uma expressao randomica
    static boolean atender() 
    {
        return new Random().nextInt(3)==1; // se o valor entre 1 e 3 for = a 1 ele atendeu, caso contrario nao atendeu
    }
